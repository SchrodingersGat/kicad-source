...
#include "panel_pref_libedit_base.h"

///////////////////////////////////////////////////////////////////////////

PANEL_PREF_LIBEDIT_BASE::PANEL_PREF_LIBEDIT_BASE( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : PANEL_PREF( parent, id, pos, size, style )
{
	...
	mainSizer->Add( fgSizer, 0, wxEXPAND, 0 );
	...
	mainSizer->Add( bSizer2, 0, wxEXPAND, 0 );
...
PANEL_PREF_LIBEDIT_BASE::~PANEL_PREF_LIBEDIT_BASE()
{
}
